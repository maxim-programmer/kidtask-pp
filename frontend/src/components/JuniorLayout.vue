...
.avatar { width: 36px; height: 36px; border-radius: 50%; background: #ea580c; color: #fff; display: flex; align-items: center; justify-content: center; font-weight: 700; font-size: 16px; cursor: pointer; overflow: hidden; flex-shrink: 0; }
...
.dropdown__item { display: block; width: 100%; padding: 14px 16px; border: none; background: transparent; text-align: left; font-size: 16px; color: #333; cursor: pointer; font-weight: 600; font-family: inherit; }
