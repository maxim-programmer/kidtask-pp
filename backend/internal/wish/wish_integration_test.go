...
func setupWishTest(t *testing.T) (*pgxpool.Pool, *mux.Router, string, string) {
	...
	// Создаём ребёнка с уникальным username и балансом 500
...
func TestWishPurchaseInsufficientBalance(t *testing.T) {
	...
	// 2. Родитель устанавливает цену выше баланса (баланс 500, ставим 1000)
	...
	// 4. Проверяем, что баланс не изменился
	var balance int
